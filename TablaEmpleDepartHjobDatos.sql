...
*Cause:LA COMA DA ERROR,     
*Action:QUITAR LA COMA
*/


INSERT INTO HJOB VALUES(7654,'T1',TO_DATE('10/01/79','DD/MM/YYYY'),TO_DATE('15/06/87','DD/MM/YYYY'),10);
INSERT INTO HJOB VALUES(7654,'T2',TO_DATE('18/01/88','DD/MM/YYYY'),TO_DATE('15/06/95','DD/MM/YYYY'),20);
INSERT INTO HJOB VALUES(7654,'T1',TO_DATE('17/06/96','DD/MM/YYYY'),'21/07/98',10);
INSERT INTO HJOB VALUES(7369,'AUXILIAR',TO_DATE('10/01/99','DD/MM/YYYY'),'15/06/00',10);
INSERT INTO HJOB VALUES(7369,'COMERCIAL',TO_DATE('10/01/02','DD/MM/YYYY'),'20/03/05',10);
INSERT INTO HJOB VALUES(7876,'AUXILIAR',TO_DATE('10/01/08','DD/MM/YYYY'),'15/06/10',30);
